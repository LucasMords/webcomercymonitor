-- ============================================
-- Schema viewep — Rode no SQL Editor do Supabase
-- ============================================

-- Recria tabela com colunas novas
...
('panorama-38', 'Panorama 38', 'O ultrawide definitivo para produtividade', 1099, '38"', '3840 x 1600', '144Hz', 'Nano IPS', '1ms', '2300R', 'HDR600', 'Branco Estelar', '#f0f0f0', '#14b8a6', ARRAY['21:9 UltraWide','Nano IPS','G-Sync Ultimate','RGB Lighting'], false, '21:9', 38, true, 'arm'),
('luxview-27', 'LuxView 27', 'Mini-LED com brilho excepcional', 949, '27"', '3840 x 2160', '165Hz', 'Mini-LED IPS', '1ms', 'Flat', 'HDR1000', 'Prata Escovado', '#c8c8c8', '#f59e0b', ARRAY['Mini-LED 1152 zonas','HDR1000','USB-C PD 90W','P3 97%'], false, '16:9', 27, false, 'minimalist'),
('curve-34', 'CurvePro 34', 'Curvatura perfeita para produtividade', 899, '34"', '3440 x 1440', '175Hz', 'VA', '1ms', '1500R', 'HDR400', 'Prata Lunar', '#c0c0c0', '#8b5cf6', ARRAY['Ultrawide QHD','1500R Curve','FreeSync Premium','PIP/PBP'], false, '21:9', 34, true, 'fixed'),
('artisan-27', 'Artisan 27', '5K Retina. Cores que inspiram.', 799, '27"', '5120 x 2880', '60Hz', 'IPS', '5ms', 'Flat', 'HDR500', 'Branco Neve', '#fafafa', '#06b6d4', ARRAY['5K Retina','True Tone','P3 Wide Color','Thunderbolt 4'], false, '16:9', 27, false, 'arm'),
('blitz-27', 'Blitz 27', '360Hz para vencer cada frame', 699, '27"', '2560 x 1440', '360Hz', 'IPS', '0.5ms', 'Flat', 'HDR400', 'Preto Furtivo', '#111111', '#f43f5e', ARRAY['360Hz','NVIDIA Reflex','ULMB 2','eSports Mode'], true, '16:9', 27, false, 'gaming'),
('nitro-24', 'Nitro 24', '540Hz puro para eSports', 549, '24.5"', '1920 x 1080', '540Hz', 'TN', '0.3ms', 'Flat', 'HDR10', 'Preto Matte', '#0d0d0d', '#22c55e', ARRAY['540Hz','DyAc+ 2','NVIDIA Reflex','Low Motion Blur'], false, '16:9', 24, false, 'gaming');
